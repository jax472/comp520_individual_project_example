/*
* Data Definition Language (DDL) for the flashcards application
*/
...
/*
* Step 5. "Seed" or insert any data that should exist upon initial database creation
*/
INSERT INTO subject (`subject_name`) VALUES ("COMP520");